...
from wcoMarkdowner import WCOMarkdowner
import os
import argparse

parser = argparse.ArgumentParser(description="Library of Heaven is Path Downloader and Ebook maker")
...
print('pandoc "' + myMarkdowner.outmd + '" --css="epub-md.css" --toc --toc-depth=2 -o "' + myMarkdowner.outEpub + '"')
